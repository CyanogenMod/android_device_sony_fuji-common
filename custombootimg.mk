...
$(INSTALLED_BOOTIMAGE_TARGET): $(TARGET_PREBUILT_KERNEL) $(recovery_ramdisk) $(INSTALLED_RAMDISK_TARGET) $(PRODUCT_OUT)/utilities/flash_image $(PRODUCT_OUT)/utilities/busybox $(PRODUCT_OUT)/utilities/erase_image $(MKBOOTIMG) $(MINIGZIP) $(INTERNAL_BOOTIMAGE_FILES)
	...
	$(hide) python $(MKELF) -o $@ $(TARGET_PREBUILT_KERNEL)@0x40208000 $(PRODUCT_OUT)/combinedroot.fs@0x41200000,ramdisk vendor/sony/nozomi/proprietary/etc/firmware/RPM.bin@0x20000,rpm
...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	$(hide) python $(MKELF) -o $@ $(TARGET_PREBUILT_KERNEL)@0x40208000 $(PRODUCT_OUT)/ramdisk-recovery.img@0x41200000,ramdisk vendor/sony/nozomi/proprietary/etc/firmware/RPM.bin@0x20000,rpm
